...
class _NotesScreenState extends State<NotesScreen> {
  ...
  Future<ModelNotes> fetchNotes() async {
    final response = await http.get(Uri.parse('http://192.168.100.110/latihan_notes/getNotes.php'));
  ...
  Future<void> addOrUpdateNote({required Datum note}) async {
    String url = note.id.isEmpty
        ? 'http://192.168.100.110/latihan_notes/addNotes.php'
        : 'http://192.168.100.110/latihan_notes/updateNotes.php';
  ...
  Future<void> deleteNote(String id) async {
    final response = await http.post(
      Uri.parse('http://192.168.100.110/latihan_notes/deleteNotes.php'),
      body: {'id': id},
    );
